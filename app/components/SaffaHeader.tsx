    ...
    <header className="saffa-site-header">
      ...
      <div className="saffa-site-actions">
        <div className="saffa-language" aria-label="Language selector">
          <button className={language === 'en' ? 'active' : ''} onClick={() => setLanguage('en')} type="button">EN</button><span>/</span><button className={language === 'ar' ? 'active' : ''} onClick={() => setLanguage('ar')} type="button">AR</button>
        </div>
