...
export default function ContactPage() {
  ...
  return (
    <main className="saffa-contact-modern">
      <header className="store-header blueprint-header contact-modern-header">
        ...
        <nav className="blueprint-nav" aria-label="Main navigation">
          <a href="/">Store</a>
          <span className="contact-region">ROW</span>
          <a href="/#collection">Collection</a>
          <a href="/contact" className="active">Contact</a>
          <a href="/" className="nav-view">Circle</a>
          <a href="/" className="cart-link">Cart</a>
        </nav>
      </header>

      <section className="contact-modern-main">
        <div className="contact-modern-heading">
          <span className="quick-label">SAFFA FASHION · CONTACT</span>
          <h1>Contact</h1>
          <p>For inquiries regarding orders, sizing, or general questions, please fill out the form below. Our team will respond as soon as possible.</p>
        </div>

        <form className="contact-form" onSubmit={submit}>
          <div className="contact-field-grid">
            <label><span>First Name</span><input name="firstName" required placeholder="First name" autoComplete="given-name" /></label>
            <label><span>Last Name</span><input name="lastName" required placeholder="Last name" autoComplete="family-name" /></label>
          </div>
