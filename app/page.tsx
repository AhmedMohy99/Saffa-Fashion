...
export default function Home() {
  ...
  const text = ar
    ? { scroll: 'اسحب', open: 'فتح', close: 'إغلاق', add: 'أضف إلى السلة', browsing: 'متابعة التصفح', selection: 'اختياراتك', yourCart: 'سلة التسوق', item: 'منتج', items: 'منتجات', empty: 'سلتك فارغة', emptyText: 'افتحي المنتج واضغطي على أضف إلى السلة لإضافته هنا.', continue: 'متابعة التسوق', total: 'الإجمالي', clear: 'إفراغ السلة', checkout: 'إتمام الطلب عبر واتساب', circle: 'دائرة', product: 'المنتج' }
    : { scroll: 'Scroll', open: 'Open', close: 'Close', add: 'Add to Cart', browsing: 'Keep Browsing', selection: 'Your Selection', yourCart: 'Your Cart', item: 'item', items: 'items', empty: 'Your cart is empty.', emptyText: 'Open a product and tap “Add to Cart” to add it here.', continue: 'Continue Shopping', total: 'Total', clear: 'Clear Cart', checkout: 'Checkout via WhatsApp', circle: 'Circle', product: 'Product' };
