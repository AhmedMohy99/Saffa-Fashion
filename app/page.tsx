...
export default function Home() {
  ...
  const text = ar
    ...
    : { scroll: 'Scroll', open: 'Open', close: 'Close', add: '🛒 Add to Cart', buy: 'Buy Now', selection: 'Your Selection', yourCart: 'Your Cart', item: 'item', items: 'items', empty: 'Your cart is empty.', emptyText: 'Open a product and tap “Add to Cart” to add it here.', continue: 'Continue Shopping', total: 'Total', clear: 'Clear Cart', checkout: 'Checkout via WhatsApp', circle: 'Circle', product: 'Product' };
