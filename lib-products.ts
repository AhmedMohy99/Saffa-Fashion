...
const twoPieceDescription = 'The Most Practical Dress is a two-piece modest set made from imported Freska linen. The oversized blouse is worn over the dress, which has an elasticated waist. Each piece can also be worn separately.';
...
export const products: Product[] = [
  ...
  { slug:'most-practical-kiwi', name:'The Most Practical Dress', arName:'The Most Practical Dress', color:'Kiwi', arColor:'كيوي', image:'/products/The Sleeveless Dress Light Olive Green.png', description:twoPieceDescription, arDescription:twoPieceArDescription, category:'summer', kind:'two-piece', price:600, originalPrice:800, saleLabel:'SALE 25%', sizeOptions:twoPieceSizes, sizeInfo:twoPieceSizeInfo, material:'Imported Freska linen', arMaterial:'كتان فريسكا مستورد', availableForInspection:true },
  ...
  { slug:'joyful-turquoise', name:'The Joyful Dress', arName:'الفستان المبهج', color:'Turquoise', arColor:'فيروزي', image:'/products/product-coming-soon.svg', description:longShirtDescription, arDescription:longShirtArDescription, category:'summer', kind:'long-shirt', price:700, originalPrice:950, saleLabel:'SALE 26%', sizeOptions:['FREE SIZE'], sizeInfo:{'FREE SIZE':'Up to 110 kg'}, material:'Textured printed linen', arMaterial:'كتان بطباعة بارزة', availableForInspection:true },
  ...
  { slug:'joyful-pink', name:'The Joyful Dress', arName:'الفستان المبهج', color:'Pink', arColor:'بينك', image:'/products/product-coming-soon.svg', description:longShirtDescription, arDescription:longShirtArDescription, category:'summer', kind:'long-shirt', price:700, originalPrice:950, saleLabel:'SALE 26%', sizeOptions:['FREE SIZE'], sizeInfo:{'FREE SIZE':'Up to 110 kg'}, material:'Textured printed linen', arMaterial:'كتان بطباعة بارزة', availableForInspection:true },

  { slug:'blazer-dress', name:'Blazer Dress', arName:'بليزر دريس', color:'Black', arColor:'أسود', image:'/products/product-coming-soon.svg', description:'A winter blazer dress made from imported soft velvet, with a fixed waist belt for a defined silhouette and two gold stainless-steel buttons. Fits up to 90 kg.', arDescription:'بليزر دريس شتوي من خامة قطيفة مستوردة ناعمة، بحزام ثابت من الوسط ليأخذ شكل الجسم، وزرارين استانلس دهبي. يلبس حتى 90 كجم.', category:'winter', kind:'blazer-dress', price:1200, originalPrice:1500, saleLabel:'SALE 20%', sizeOptions:['FREE SIZE'], sizeInfo:{'FREE SIZE':'Up to 90 kg'}, material:'Imported soft velvet', arMaterial:'قطيفة مستوردة ناعمة', availableForInspection:true },
  { slug:'formal-black-suite', name:'Formal Black Suite', arName:'Formal Black Suite', color:'Black', arColor:'أسود', image:'/products/Formal Black Suite.jpeg', description:'A polished formal black modest suit designed for elevated occasions. Choose your size and confirm the order through WhatsApp.', arDescription:'بدلة سوداء فورمال محتشمة بإطلالة راقية للمناسبات. اختاري المقاس وأكدي الطلب عبر واتساب.', category:'winter', kind:'formal-suite', price:1000, sizeOptions:twoPieceSizes, sizeInfo:{ L:'50–75 kg', XL:'75–110 kg' }, availableForInspection:true },
];
